...
| S04 | Add-ons/Search/Discover/Library | in progress (Sonnet 5, ∥ S05) | `claude/android-s04-breadth` | dispatched 2026-07-12 off main @ c1648a3; owns core/ + OtherScreens.kt; engine edits additive-only |
| S05 | Detail + metadata | in progress (Sonnet 5, ∥ S04) | `claude/android-s05-detail` | dispatched 2026-07-12 off main @ c1648a3; owns DetailScreen.kt + detail route; engine edits additive-only |
